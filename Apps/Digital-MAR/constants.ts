...
export const HOMES_BY_REGION: HomeRegion[] = [
  ...
  },
  {
    ...
    homes: [
      ...
      { id: 'home-chaleur-10', name: 'Le Foyer Le P\'tit Abri' },
    ]
  },
  {
    region: 'Edmundston',
  ...
  residents: [
    {
      ...
      notes: 'Prefers medication with apple sauce.',
    },
    {
      id: 'res-2',
      name: 'Robert Paulson',
    ...
    },
    {
      ...
      notes: 'Monitor for dizziness after evening medication.',
    },
     {
      id: 'res-4',
      ...
      notes: 'Weekly blood tests required.'
    },
  ],
  records: {},
  auditLog: [],

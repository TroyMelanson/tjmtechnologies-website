...
const demos = [
  {
    ...
    challenge:
      'Managing staff schedules, tracking expenses, monitoring finances, and handling resident information was a manual, time-consuming, and error-prone process, leading to administrative overhead and less time for resident care.',
    solution:
      'A comprehensive business management application featuring modules for employee scheduling, financial dashboards, salary calculation, and resident management. It provides a centralized platform to streamline all administrative tasks.',
    result:
      'The suite saves hundreds of administrative hours, reduces scheduling conflicts, provides real-time financial insights for better decision-making, and improves overall operational efficiency, allowing staff to focus more on providing quality care.',
  },
  {
    id: 2,
    title: 'Digital-MAR',
    ...
    challenge:
      'Paper-based Medication Administration Records (MAR) were inefficient, prone to errors, and created communication delays between the care home and the pharmacy, posing risks to resident safety and compliance.',
    solution:
      'A secure, cloud-based electronic medication record system built on Azure. It enables real-time, two-way communication, allowing staff to record administrations electronically and pharmacists to manage prescriptions instantly.',
    result:
      'Drastically reduced medication errors, improved resident safety, and created a seamless, real-time workflow between the care home and pharmacy, saving time and improving accuracy for both parties.',
  },
];

const CaseStudyDetail: React.FC<{ title: string; content: string }> = ({
  title,
  content,
}) => (
  <div>
...
const DemoCaseStudy: React.FC<DemoCaseStudyProps> = ({
  isReversed = false,
  onViewDemo,
  ...demo
}) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-400">
            A showcase of my capabilities and recent work.
          </p>
        </div>
        ...
        >
          <div className="bg-secondary rounded-lg shadow-xl w-full max-w-sm m-4 p-8 relative">
            ...
            <p className="text-gray-400 mb-6">
              Please enter the password to view the live demo.
            </p>
